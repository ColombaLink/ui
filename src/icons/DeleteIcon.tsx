...
export const DeleteIcon = ({ color = "currentColor", ...props }) => {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" {...props}>
      <path
        ...
        stroke-width="1.5"
      />
      <path d="M11.6665 9.1665V14.1665" stroke={color} stroke-width="1.5" />
      <path d="M8.3335 9.1665V14.1665" stroke={color} stroke-width="1.5" />
    </svg>
  );
};

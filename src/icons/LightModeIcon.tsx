  ...
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none" {...props}>
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M10 0.833496V2.50016" stroke={color} strokeWidth="1.5" />
      <path d="M10 17.5V19.1667" stroke={color} strokeWidth="1.5" />
      <path
        d="M3.5166 3.5166L4.69993 4.69993"
        stroke={color}
        strokeWidth="1.5"
      />
      <path d="M15.3 15.3L16.4834 16.4834" stroke={color} strokeWidth="1.5" />
      <path d="M0.833496 10H2.50016" stroke={color} strokeWidth="1.5" />
      <path d="M17.5 10H19.1667" stroke={color} strokeWidth="1.5" />
